...
void generator_routine_1_bkg() {
	...
	TH1F* h11b = new TH1F("h11b", "p_{T} of J/#psi; p_{T} (GeV/c)", 100, 0, 140);
	...
	TH1F* h12b = new TH1F("h12b", "p_{T} of #gamma; p_{T} (GeV/c)", 100, 0, 3);
	TH1F* h22b = new TH1F("h22b", "y of #gamma; y", 100, -11, 11);
	TH1F* h32b = new TH1F("h32b", "#eta of #gamma; #eta", 100, -11, 11);
	TH1F* h42b = new TH1F("h42b", "E of #gamma; E(GeV)", 100, 0, 40);
	TH1F* h13b = new TH1F("h13b", "p_{T} of #mu; p_{T} (GeV/c)", 100, 0, 50);
	TH1F* h23b = new TH1F("h23b", "y of #mu; y", 100, -8, 8);
	TH1F* h33b = new TH1F("h33b", "#eta of #mu; #eta", 100, -8, 8);
	TH1F* h43b = new TH1F("h43b", "E of #mu; E (GeV)", 100, 0, 500);
	...
	//Insert the .root file and get the tree and its Event branch
		...
		Int_t iAntiMuon = 0;
			...
			if (part->GetPdgCode() == 22 && part->GetStatusCode() > 0) {
	...
	TText* t1 = new TText(60,40,"nEvents = 1000");
	TText* t2 = new TText(60,50,"Pythia generator results");
	TLatex t3;
	
	c1->Clear();
	c1->Divide(2,2);
	c1->cd(1); h11b->Draw(); t1->Draw(); t2->Draw();
	c1->cd(2); h21b->Draw();
	c1->cd(3); h31b->Draw();
	c1->cd(4); h41b->Draw();
	...
	c1->cd(4); h42b->Draw();
	c1->Print("jpsi_inclusive.pdf");
	c1->cd(1); h13b->Draw(); t3.DrawLatex(15,100,"Both #mu^{-} and #mu^{+} are counted");
	c1->cd(2); h23b->Draw();
	c1->cd(3); h33b->Draw();
	c1->cd(4); h43b->Draw();
	c1->Print("jpsi_inclusive.pdf)");
