...
void generator_jpsi_pt() {
	TStopwatch t;

	//Define all the histograms
	TCanvas* c2 = new TCanvas("c2", "trial analysis", 1);
	TH1I* hsignal = new TH1I("hsignal","p_{T} of J/#psi for signal;p_{T} (GeV/c)",100, 0, 200);
	TH1I* hbkg = new TH1I("hbkg","S: p_{T} of J/#psi for bkg;p_{T} (GeV/c)",100, 0, 200);
	...
	hpt->Draw("nostack"); legend->Draw();
        c2->Print("generator_jpsi_pt.pdf");
