...
void generator_routine_1() {
	...
	TText* t1 = new TText(120,300,"nEvents = 8000");
	TText* t2 = new TText(120,400,"Pythia generator results");
	TText* t4 = new TText(120,350,"H->J/psi gamma signal production");
	TLatex t3;
	...
	c1->cd(3); h30->Draw();
	c1->cd(4); h40->Draw();
	c1->cd(1); t1->Draw(); t2->Draw(); t4->Draw();
	c1->Print("signal_hists.pdf(");
	c1->cd(1); h11->Draw();
	c1->cd(2); h21->Draw();
	c1->cd(3); h31->Draw();
	c1->cd(4); h41->Draw();
